...
7. **The interface's fifth and sixth constructions are the same shape.** Four prompts in this batch, and every one of them is true, and every one places the cost in the grammatical position where a cost goes. Adrian has now read the *shape* of an offer rather than its content, which is the standing test the Bible requires and the thing the Choir is counting on. Do not let him pass one.
