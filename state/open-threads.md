...
Status after Batch 0001 (Chapters 1–10). A promise becomes active when the prose pays it and is discharged when the book or the event closes it.
...
- **Not yet surfaced in prose.** What is the First Grammar, and how did the First Sundering split it? The name is not used in Chapters 1–10.
- **Opened in Marrow's mouth, Chapter 7.** What did the earlier Bright Pilgrims cross, what happened to them, and why is Ivenn's copy of Adrian's own sentence coming *through a wall*?
- **Opened Chapter 7.** Ivenn knows more about the interface than he explains, and he is the only person in the batch who is *not* frightened by it.
- **Opened Chapter 8.** Something is standing in the lock join using the old form of the oath, learning an older fifth syllable, spending the bottom field an hour at a time, and it knows Adrian's name.
- **Not yet surfaced.** Can a plural bridge remain stable without a single authority? The Chapter 10 instrument is the first attempt and it is empty.

## Immediate Volume 01 promises

- **The main breach is still open and wider than on arrival.** It is watched, and Vail has entered that fact in the book rather than a failure. The volume's gate is whether it can be closed without putting one hand in charge. *Not discharged.*
- **The bottom field's lost season is a live clock.** Adrian's debt is reviewable on the last day of the salt month, and the same pressure is still being spent. *Active.*
- **Nine Elms' refusal can be withdrawn on any day**, and Tamsin has told Adrian in advance that somebody will try to argue that a refusal given in a hearing is not a refusal given in a commitment. *Active and dangerous.*
...
- **Adrian and Nora.** Three missed calls on the eleventh, one unanswered text, and a sister who runs a mutual-aid rota and does not know he is gone. Earthside cost has not touched the page yet. *Unopened.*
- **Adrian and Tamsin: professional respect, no romantic milestone.** She checks him, he has agreed to be checkable, and she has told him she will keep checking. *Active, slow.*
- **Mina and Adrian disagree about consent and record-keeping**, and the disagreement is the engine of their working relationship. She has a book with two numbers in it. *Active.*
